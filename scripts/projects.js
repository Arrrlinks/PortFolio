document.addEventListener("DOMContentLoaded", async () => {
    ...
    function createProjectCard(project) {
        ...
        <article class="project-card">
            <a class="project-link" href="./projects/${project.long}" aria-label="Open Project 2">
              <img class="project-img" src="imgs/${project.image}" alt="Project 2 image">
              <div class="project-info">
                  <h3 class="project-title">${project.title}</h3>
                  <p class="project-desc">${project.description}</p>
                  <div class="project-meta">${project.skills.join(" • ")}</div>
              </div>
            </a>
        </article>`
    ...
    // Load projects and append to container&
